...
export const metadata = { title: "First 3 Months Guide" };

export default function FirstThreeMonthsPage() {
  const content = readFileSync(
    path.join(process.cwd(), "content/newcomer/first-three-months.md"),
    "utf-8"
  );
  ...
  return (
    <div className="page-container py-12">
      ...
      <div className="mt-12 flex gap-4">
        ...
        <Link href="/directory" className="btn-primary text-sm">
          Find Professionals →
        </Link>
      </div>
    </div>
