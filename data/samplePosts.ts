...
export const samplePosts: SamplePost[] = [
  ...
  },
  {
    ...
    author_id: "user-4",
    category: "lost_found",
    title: "Lost: Brown leather wallet near Islamic Association of Raleigh (IAR)",
    body: "Assalamu Alaikum brothers and sisters. I lost my brown leather wallet last Friday (April 12) near the Islamic Association of Raleigh (IAR) — either in the parking lot or inside near the prayer hall. It contains my NC driver's license, a debit card, and some cash. If anyone found it, please contact me. JazakAllah khair. May Allah reward you.",
